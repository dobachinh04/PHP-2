                ...
                <div class="row m-auto">
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="mb-3 mt-3">
                            ...
                            <select class="form-select" id="category_id" name="category_id">
                                @foreach ($categories as $category)
                                    <option @if ($category['id'] == $post['c_id']) selected @endif value="{{ $category['id'] }}">
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" class="form-control" id="excerpt" value="{{ $post['p_excerpt'] }}"
                                required placeholder="Nhập Mô tả ngắn" name="excerpt">
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="content" class="form-label">Nội dung:</label>
                            <input type="text" class="form-control" id="content" value="{{ $post['p_content'] }}"
                        ...
                        <div class="mb-3">
                            ...
                            <img class="mt-3" src="{{ $post['p_image'] }}" width="100px">
                        </div>
        ...
        <a href="/admin/posts" class="btn btn-info" style="font-weight: bold; color: white;"><-- Quay Lại Danh Sách</a>
                ...
                <div class="row">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 mt-3">
                            <label for="title" class="form-label">Tiêu Đề Bài Đăng:</label>
                            <input type="text" class="form-control" id="title" value="{{ $post['p_title'] }}" required
                                placeholder="Nhập Tiêu Đề" name="title">
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="excerpt" class="form-label">Mô tả ngắn:</label>
                            <input type="text" class="form-control" id="excerpt" value="{{ $post['p_excerpt'] }}" required
                                placeholder="Nhập Mô tả ngắn" name="excerpt">
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="content" class="form-label">Nội dung:</label>
                            <input type="text" class="form-control" id="content" value="{{ $post['p_content'] }}" required
